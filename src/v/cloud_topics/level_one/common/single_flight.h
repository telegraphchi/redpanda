...
public:
    ...
    run(std::filesystem::path cache_key, ss::abort_source& as, WorkFn work);
...
ss::future<single_flight::run_result> single_flight::run(
  std::filesystem::path cache_key, ss::abort_source& as, WorkFn work) {
